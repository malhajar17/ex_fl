...
# Adapted from: https://github.com/huggingface/diffusers/blob/main/examples/text_to_image/train_text_to_image_lora_sdxl.py
...
from dataset.prepare_save_text_to_image import process_train_dataset
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--train_dataset_load_dir",
        type=str,
        default=None,
        help=(
            "Directory to load the train dataset using the "
            "`datasets.load_from_disk` method. No preparation will be done"
    ...
    if (
        ...
        and args.train_dataset_load_dir is None
    ):
        raise ValueError(
            "Need either a dataset name or a training folder or a training dataset load directory."
        )
...
def main(args):
    ...
    train_dataset = process_train_dataset(args, accelerator)
